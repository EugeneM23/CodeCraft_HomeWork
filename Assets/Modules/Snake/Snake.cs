...
namespace Modules
{
    ...
    public sealed class Snake : MonoBehaviour, ISnake
    {
        ...
        [Header("Spine")] [FormerlySerializedAs("_bodyPrefab")] [SerializeField]
        private Transform _bonePrefab;

        [FormerlySerializedAs("_initialBody")] [SerializeField]
        private Transform[] _initialBones;

        [Header("Movement")] [SerializeField] private float _speed = 2;

        [SerializeField] private SnakeDirection _currentDirection = SnakeDirection.UP;

        [Title("Debug")] [ShowInInspector, ReadOnly, HideInEditorMode]
