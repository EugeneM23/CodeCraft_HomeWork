...
namespace Modules.Entities
{
    ...
    public sealed class EntityWorld : SerializedMonoBehaviour
    {
        ...
        [OdinSerialize] private Dictionary<EntityType, Transform> _containers;
        ...
        public Entity Spawn(EntityConfig config, Vector3 position, Quaternion rotation, int id = -1)
        {
            ...
            Entity entity = _diContainer.InstantiatePrefab(config.Prefab, position, rotation, container)
                .GetComponent<Entity>();
