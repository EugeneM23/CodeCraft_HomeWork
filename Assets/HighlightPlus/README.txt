...
Version 32.5
- Highlight Trigger: added "Blocking Layer Mask" option to prevent highlighting when objects in the specified layer mask are between the camera and the target
- Internal improvements

Version 32.4
- See-through: added "Fade Range" option next to Max Depth to smoothly fade hidden objects near the cutoff distance
