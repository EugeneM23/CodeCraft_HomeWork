...
{
    public class DashSfxAttackAction : DashComponent.IAction, IInitializeble
    {
        ...
        public void Invoke()
        {
            _audioSystem.PlayEvent(MasterBankAPI.JumpEvent, _character.Transfrom.position, Quaternion.identity,
                MAX_FRIQUIENCY);
        }
    }
}