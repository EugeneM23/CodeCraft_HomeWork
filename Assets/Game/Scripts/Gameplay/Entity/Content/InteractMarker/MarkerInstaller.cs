...
namespace Game
{
    public class MarkerInstaller : SceneEntityInstaller
    {
        ...
        {
            entity.AddBehaviour(new MarkerPositionBehaviour(_positionOffset, transform, _view));
        }
    }

    public class MarkerPositionBehaviour : IEntityUpdate, IEntityInit
    {
        ...
        public MarkerPositionBehaviour(Vector3 positionOffset, Transform transform, GameObject view)
        {
            _view = view;
