...
namespace Game
{
    public class InteractMarkerTransformBehaviour : IEntityUpdate, IEntityInit
    {
        ...
        public InteractMarkerTransformBehaviour(Vector3 positionOffset, Transform transform, GameObject view)
        {
            _view = view;
